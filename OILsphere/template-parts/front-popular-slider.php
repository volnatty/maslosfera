...
<section id="front-popul" class="popular-section">
        ...
        <div class="row">
            <div class="col-xxl-3">
                ...
                <div class="popular-text">
                    <?php echo the_field('popul_slider_text') ?>
                </div>
                <a href="<?php get_site_url(); ?>shop/" class="btn btn-secondary btn-lg mt-10 mb-4 mb-xxl-0"><span>КАТАЛОГ</span></a>
            </div>
            <div class="col">
                <div class="row">
                ...
                <div class="slider-nav slider-nav--popul d-flex align-items-center justify-content-between">
